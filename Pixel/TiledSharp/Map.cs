...
namespace TiledSharp
{
    public class TmxMap : TmxDocument
    {
        ...
        public TmxList<TmxTileset> Tilesets { get; set; }
        public TmxList<TmxLayer> TileLayers { get; set; }
        public TmxList<TmxObjectGroup> ObjectGroups { get; set; }
        public TmxList<TmxImageLayer> ImageLayers { get; set; }
