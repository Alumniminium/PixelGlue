...
namespace PixelGlueCore.ECS
{
    public static class AssetManager
    {
        ...
        public static void LoadTexture(string textureName, ContentManager _contentManager) => Textures.TryAdd(textureName, _contentManager.Load<Texture2D>(textureName.Split('.')[0]));
